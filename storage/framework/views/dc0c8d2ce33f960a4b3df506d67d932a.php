...
<div class="w-full overflow-hidden px-0">
    <div class="relative flex items-start w-full" style="overflow: hidden;">
        ...
        <div class="absolute h-0.5 z-0" 
             style="top: 21px; left: <?php echo e($lineLeft); ?>; right: <?php echo e($lineRight); ?>; box-sizing: border-box;">
            <!-- Background line -->
            <div class="h-full w-full bg-white/20" style="max-width: 100%;"></div>
            <!-- Progress line -->
            <?php if($lastCompletedIndex >= 0 && count($timeline) > 1): ?>
            <?php
            ...
            <div class="absolute top-0 left-0 h-full bg-primary transition-all duration-300" 
                 style="width: <?php echo e($progressWidth); ?>%; max-width: 100%; overflow: hidden;">
            </div>
            <?php endif; ?>
        </div>
        ...
        <div class="absolute h-0.5 z-0 hidden sm:block" 
             style="top: 25px; left: <?php echo e($lineLeft); ?>; right: <?php echo e($lineRight); ?>; box-sizing: border-box;">
            <!-- Background line -->
            <div class="h-full w-full bg-white/20" style="max-width: 100%;"></div>
            <!-- Progress line -->
            <?php if($lastCompletedIndex >= 0 && count($timeline) > 1): ?>
