...
<?php endif; ?>
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-2xl bg-gradient-to-br from-white/5 via-white/5 to-white/5 border border-white/10 p-6">
                    ...
                    <a href="<?php echo e(route('chat.show', $service->user->id)); ?>" class="block w-full px-4 py-3 rounded-lg border-2 border-green-500/30 bg-green-500/20 text-green-400 hover:bg-green-500/30 hover:border-green-500/50 transition-all font-semibold mb-5 flex items-center justify-center gap-2">
                        <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
