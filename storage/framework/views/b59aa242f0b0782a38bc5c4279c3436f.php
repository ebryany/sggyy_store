<?php $__env->startSection('title', $service->title . ' - Ebrystoree'); ?>
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-primary/10 via-transparent to-transparent py-8 sm:py-12">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <nav class="mb-6 text-sm text-white/60">
                ...
                <a href="<?php echo e(route('services.index')); ?>" class="hover:text-primary transition-colors">Jasa</a>
                <span class="mx-2">/</span>
                <span class="text-white/90"><?php echo e(Str::limit($service->title, 30)); ?></span>
            </nav>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'game','class' => 'w-12 h-12 sm:w-14 sm:h-14 text-primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'game','class' => 'w-12 h-12 sm:w-14 sm:h-14 text-primary']); ?>
...
<?php endif; ?>
                            ...
                            <p class="text-primary font-bold text-xl sm:text-2xl uppercase tracking-wider">
                                <?php echo e(Str::limit($service->title, 3)); ?>
...
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?>
                                    <span class="font-bold text-lg ml-1"><?php echo e(number_format($service->averageRating(), 1)); ?></span>
                                </div>
                                <span class="text-white/60 text-sm">(<?php echo e($service->ratings->count()); ?> ulasan)</span>
                            </div>
                            <?php endif; ?>
                        </div>
...
<?php endif; ?>
                            ...
                            <?php if($service->status === 'active'): ?>
                            <span class="px-4 py-2 rounded-lg bg-green-500/20 text-green-400 border border-green-500/30 text-sm font-medium">Aktif</span>
                            <?php endif; ?>
                            <?php if($service->completed_count > 0): ?>
                            <span class="px-4 py-2 rounded-lg bg-blue-500/20 text-blue-400 border border-blue-500/30 text-sm font-medium flex items-center gap-1.5">
                                <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?>
                                <span><?php echo e($service->completed_count); ?> selesai</span>
                            </span>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                        <div class="p-4 sm:p-5 rounded-xl bg-gradient-to-br from-primary/20 via-primary/10 to-primary/5 border border-primary/30 text-center">
                            <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'check','class' => 'w-5 h-5 sm:w-6 sm:h-6 text-primary mx-auto mb-2.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'check','class' => 'w-5 h-5 sm:w-6 sm:h-6 text-primary mx-auto mb-2.5']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?>
                            <div class="text-xl sm:text-2xl font-bold text-white mb-1"><?php echo e(number_format($service->completed_count)); ?></div>
                            <div class="text-xs sm:text-sm text-white/60">Selesai</div>
                        </div>
                        <div class="p-4 sm:p-5 rounded-xl bg-gradient-to-br from-primary/20 via-primary/10 to-primary/5 border border-primary/30 text-center">
                            <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'clock','class' => 'w-5 h-5 sm:w-6 sm:h-6 text-primary mx-auto mb-2.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'clock','class' => 'w-5 h-5 sm:w-6 sm:h-6 text-primary mx-auto mb-2.5']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?>
                            <div class="text-xl sm:text-2xl font-bold text-white mb-1"><?php echo e($service->duration_hours); ?></div>
                            <div class="text-xs sm:text-sm text-white/60">Jam</div>
                        </div>
                        <div class="p-4 sm:p-5 rounded-xl bg-gradient-to-br from-primary/20 via-primary/10 to-primary/5 border border-primary/30 text-center">
                            <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => ''.e($service->status === 'active' ? 'check' : 'x').'','class' => 'w-5 h-5 sm:w-6 sm:h-6 '.e($service->status === 'active' ? 'text-green-400' : 'text-red-400').' mx-auto mb-2.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => ''.e($service->status === 'active' ? 'check' : 'x').'','class' => 'w-5 h-5 sm:w-6 sm:h-6 '.e($service->status === 'active' ? 'text-green-400' : 'text-red-400').' mx-auto mb-2.5']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?>
                            <div class="text-xl sm:text-2xl font-bold text-white mb-1"><?php echo e($service->status === 'active' ? 'Aktif' : 'Nonaktif'); ?></div>
                            <div class="text-xs sm:text-sm text-white/60">Status</div>
                        </div>
                        <div class="p-4 sm:p-5 rounded-xl bg-gradient-to-br from-primary/20 via-primary/10 to-primary/5 border border-primary/30 text-center">
                            <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?>
                            <div class="text-xl sm:text-2xl font-bold text-white mb-1">
                                <?php echo e($service->ratings->count() > 0 ? number_format($service->averageRating(), 1) : '-'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="rounded-2xl bg-gradient-to-br from-white/5 via-white/5 to-white/5 border border-white/10 p-6 sm:p-8">
                    <h2 class="text-2xl font-bold mb-6 text-white">Pesan Jasa Ini</h2>
...
<?php endif; ?>
                                ...
                                <?php if(isset($featureFlags) && $featureFlags['enable_xendit']): ?>
                                <!-- Xendit VA -->
                                <label class="flex items-center p-4 rounded-xl bg-white/5 border-2 cursor-pointer transition-all group"
...
<?php endif; ?>
                                ...
                                <?php if(isset($featureFlags) && $featureFlags['enable_bank_transfer'] && (!isset($featureFlags['enable_xendit']) || !$featureFlags['enable_xendit'])): ?>
                                <label class="flex items-center p-4 rounded-xl bg-white/5 border-2 cursor-pointer transition-all group"
...
<?php endif; ?>
                                ...
                                <?php if(isset($featureFlags) && $featureFlags['enable_qris'] && (!isset($featureFlags['enable_xendit']) || !$featureFlags['enable_xendit'])): ?>
                                <label class="flex items-center p-4 rounded-xl bg-white/5 border-2 cursor-pointer transition-all group"
...
<?php endif; ?>
                                <div class="text-sm text-white/90">
                                    <p class="font-semibold text-blue-400 mb-1 flex items-center gap-2">
                                        ...
                                        <?php if(isset($featureFlags) && ($featureFlags['enable_xenplatform'] ?? false)): ?>
...
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?>
                                Upload Tugas (Opsional)
                            </label>
                            <div class="p-4 rounded-xl bg-white/5 border border-white/10">
                                <input type="file" 
                                       name="task_file" 
                                       accept=".pdf,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.zip,.rar,.txt,.jpg,.jpeg,.png"
                                       class="w-full border border-white/10 rounded-lg px-4 py-2.5 bg-white/5 focus:outline-none focus:border-primary text-sm cursor-pointer">
                                <p class="text-xs text-white/60 mt-2">
                                    Format: PDF, DOC, DOCX, XLS, XLSX, PPT, PPTX, ZIP, RAR, TXT, JPG, JPEG, PNG (Max 10MB)
                                </p>
                            </div>
                        </div>
...
<?php endif; ?>
                            ...
                            <div class="bg-white p-4 rounded-lg mb-4 flex justify-center">
                                <div id="qris-code-service" class="w-full max-w-xs"></div>
                            </div>
                            <script>
                                document.getElementById('qris-code-service').innerHTML = '<img src="data:image/png;base64,<?php echo e($bankAccountInfo['qris_code']); ?>" alt="QRIS" class="w-full">';
                            </script>
                            <?php endif; ?>
                            <p class="text-xs text-white/60 mt-4 flex items-center gap-1">
                                <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
...
<?php endif; ?>
                        ...
                        <button type="submit" 
                            ...
                            <span x-show="!loading" class="flex items-center justify-center gap-2">
                                <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'game','class' => 'w-5 h-5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'game','class' => 'w-5 h-5']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?>
                    <h3 class="text-xl font-semibold mb-2 text-white">Jasa Tidak Tersedia</h3>
                    <p class="text-white/60">Jasa ini sedang tidak aktif untuk sementara waktu.</p>
                </div>
                <?php endif; ?>
                ...
                <?php if($service->ratings->count() > 0): ?>
                <div class="rounded-2xl bg-gradient-to-br from-white/5 via-white/5 to-white/5 border border-white/10 p-6 sm:p-8">
                    <h2 class="text-2xl font-bold mb-6 text-white">Ulasan (<?php echo e($service->ratings->count()); ?>)</h2>
                    <div class="space-y-6">
                        <?php $__currentLoopData = $service->ratings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
            ...
            <div class="space-y-6">
                ...
                <div class="rounded-2xl bg-gradient-to-br from-white/5 via-white/5 to-white/5 border border-white/10 p-6">
                    ...
                    <?php if($service->user->store_slug): ?>
                    <a href="<?php echo e(route('store.show', $service->user->store_slug)); ?>" class="block group">
                    <?php endif; ?>
                        <div class="flex items-start gap-4 mb-5">
                            <div class="relative flex-shrink-0">
                                <img src="<?php echo e($service->user->avatar ?? 'https://ui-avatars.com/api/?name=' . urlencode($service->user->name)); ?>" 
                                     alt="<?php echo e($service->user->name); ?>" 
                                     class="w-16 h-16 rounded-full border-2 border-white/10 group-hover:border-primary transition-colors">
                                <?php if($service->user->updated_at && $service->user->updated_at->gt(now()->subMinutes(5))): ?>
                                <span class="absolute bottom-0 right-0 w-4 h-4 bg-green-500 border-2 border-dark rounded-full"></span>
                                <?php endif; ?>
                            </div>
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-2 mb-1">
                                    <p class="font-semibold text-lg truncate group-hover:text-primary transition-colors"><?php echo e($service->user->name); ?></p>
                                    <?php if($service->user->isSeller() || $service->user->isAdmin()): ?>
                                ...
                                <?php
                                    $sellerRating = $service->user->services()->whereHas('ratings')->with('ratings')->get()->pluck('ratings')->flatten();
                                    $avgRating = $sellerRating->avg('rating') ?? 0;
                                    $totalCompleted = $service->user->services()->sum('completed_count');
                                ?>
                                <?php if($avgRating > 0): ?>
                                <div class="flex items-center gap-2 text-sm mb-2">
                                    ...
                                    <span class="text-white/60">(<?php echo e($totalCompleted); ?> selesai)</span>
                                </div>
                                <?php endif; ?>
                                <?php if($service->user->store_slug): ?>
                    ...
                    <?php if(auth()->id() !== $service->user_id): ?>
                    <a href="<?php echo e(route('chat.show', '@' . $service->user->username)); ?>" class="block w-full px-4 py-3 rounded-lg border-2 border-green-500/30 bg-green-500/20 text-green-400 hover:bg-green-500/30 hover:border-green-500/50 transition-all font-semibold mb-5 flex items-center justify-center gap-2">
                        <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?>
                    ...
                    <div class="space-y-3 text-sm border-t border-white/10 pt-5">
                        <div class="flex justify-between items-center">
                            <span class="text-white/60">Jasa</span>
                            <span class="font-semibold text-white"><?php echo e($service->user->services()->count()); ?></span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-white/60">Bergabung</span>
                            <span class="font-semibold text-white"><?php echo e($service->user->created_at->format('d M Y')); ?></span>
                        </div>
                    </div>
                    
                    <?php if($service->user->isSeller() && $service->user->store_slug): ?>
                    <div class="mt-5 pt-5 border-t border-white/10">
                        <a href="<?php echo e(route('store.show', $service->user->store_slug)); ?>" class="text-primary hover:text-primary-dark text-sm font-semibold flex items-center justify-center gap-2 transition-colors">
                            <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
...
<?php endif; ?>
                ...
                <!-- Edit/Delete Actions -->
                <?php if(auth()->check() && (auth()->id() === $service->user_id || auth()->user()->isAdmin())): ?>
                <div class="rounded-2xl bg-gradient-to-br from-white/5 via-white/5 to-white/5 border border-white/10 p-6">
                    <h3 class="font-semibold mb-4 text-white">Kelola Jasa</h3>
                    <div class="space-y-3">
                        <a href="<?php echo e(route('seller.services.edit', $service)); ?>" 
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirm-modal','data' => ['id' => 'delete-service-modal','title' => 'Hapus Jasa','message' => 'Yakin ingin menghapus jasa ini? Tindakan ini tidak dapat dibatalkan.','confirmText' => 'Ya, Hapus','cancelText' => 'Batal','type' => 'danger']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'delete-service-modal','title' => 'Hapus Jasa','message' => 'Yakin ingin menghapus jasa ini? Tindakan ini tidak dapat dibatalkan.','confirm-text' => 'Ya, Hapus','cancel-text' => 'Batal','type' => 'danger']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <form id="delete-service-form" method="POST" action="<?php echo e(route('seller.services.destroy', $service)); ?>" style="display: none;">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\febry\Documents\my_jasa\resources\views/services/show.blade.php ENDPATH**/ ?>