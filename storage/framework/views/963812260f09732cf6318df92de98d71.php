...
<?php $__env->startSection('title', 'Wallet - Seller Dashboard - Ebrystoree'); ?>
...
<?php endif; ?>
        ...
        <a href="<?php echo e(route('seller.wallet.topUp')); ?>" 
...
<?php endif; ?>
    ...
    <!-- Filters -->
    <div class="glass p-4 sm:p-6 rounded-lg" x-data="{ type: '<?php echo e(request('type') ?? ''); ?>', status: '<?php echo e(request('status') ?? ''); ?>' }">
...
<?php endif; ?>
        ...
        <form method="GET" action="<?php echo e(route('seller.wallet.index')); ?>" class="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <select name="type" 
                    x-model="type" 
...
<?php echo $__env->make('seller.layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\febry\Documents\my_jasa\resources\views/seller/wallet/index.blade.php ENDPATH**/ ?>