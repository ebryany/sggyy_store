...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirm-modal','data' => ['id' => 'verify-payment-simple-modal-'.e($payment->id).'','title' => 'Verifikasi Pembayaran','message' => 'Yakin verifikasi pembayaran ini?','confirmText' => 'Ya, Verifikasi','cancelText' => 'Batal','type' => 'info','formId' => 'verify-payment-simple-form-'.e($payment->id).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'verify-payment-simple-modal-'.e($payment->id).'','title' => 'Verifikasi Pembayaran','message' => 'Yakin verifikasi pembayaran ini?','confirm-text' => 'Ya, Verifikasi','cancel-text' => 'Batal','type' => 'info','formId' => 'verify-payment-simple-form-'.e($payment->id).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                    ...
                    <?php if($payment->status === 'pending'): ?>
                    <div id="verify-payment-modal-<?php echo e($payment->id); ?>"
