...
<?php $__env->startSection('title', 'Tambah Produk - Ebrystoree'); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="short_description" 
                                  ...
                                  class="w-full glass border border-white/10 rounded-lg px-4 py-3 sm:py-2 bg-white/5 focus:outline-none focus:border-primary text-base touch-target"><?php echo e(old('short_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="description" 
                                  ...
                                  class="w-full glass border border-white/10 rounded-lg px-4 py-3 sm:py-2 bg-white/5 focus:outline-none focus:border-primary text-base touch-target"><?php echo e(old('description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="product_type" 
                                ...
                                <option value="Template" <?php echo e(old('product_type') == 'Template' ? 'selected' : ''); ?>>Template</option>
                                <option value="Plugin" <?php echo e(old('product_type') == 'Plugin' ? 'selected' : ''); ?>>Plugin</option>
                                <option value="Script" <?php echo e(old('product_type') == 'Script' ? 'selected' : ''); ?>>Script</option>
                                <option value="Theme" <?php echo e(old('product_type') == 'Theme' ? 'selected' : ''); ?>>Theme</option>
                                <option value="Add-on" <?php echo e(old('product_type') == 'Add-on' ? 'selected' : ''); ?>>Add-on</option>
                                <option value="Extension" <?php echo e(old('product_type') == 'Extension' ? 'selected' : ''); ?>>Extension</option>
                                <option value="Module" <?php echo e(old('product_type') == 'Module' ? 'selected' : ''); ?>>Module</option>
                                <option value="Lainnya" <?php echo e(old('product_type') == 'Lainnya' ? 'selected' : ''); ?>>Lainnya</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <select name="category" required
                            ...
                            <option value="Template" <?php echo e(old('category') == 'Template' ? 'selected' : ''); ?>>Template</option>
                            <option value="Plugin" <?php echo e(old('category') == 'Plugin' ? 'selected' : ''); ?>>Plugin</option>
                            <option value="Script" <?php echo e(old('category') == 'Script' ? 'selected' : ''); ?>>Script</option>
                            <option value="Theme" <?php echo e(old('category') == 'Theme' ? 'selected' : ''); ?>>Theme</option>
                            <option value="Add-on" <?php echo e(old('category') == 'Add-on' ? 'selected' : ''); ?>>Add-on</option>
                            <option value="Extension" <?php echo e(old('category') == 'Extension' ? 'selected' : ''); ?>>Extension</option>
                            <option value="Module" <?php echo e(old('category') == 'Module' ? 'selected' : ''); ?>>Module</option>
                            <option value="Asset" <?php echo e(old('category') == 'Asset' ? 'selected' : ''); ?>>Asset</option>
                            <option value="Tool" <?php echo e(old('category') == 'Tool' ? 'selected' : ''); ?>>Tool</option>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="glass p-4 sm:p-6 rounded-lg">
                <h2 class="text-xl font-semibold mb-6 flex items-center gap-2">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'image','class' => 'w-5 h-5 text-primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'image','class' => 'w-5 h-5 text-primary']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
        ...
        <div x-show="activeTab === 'file'" x-cloak class="space-y-6">
            ...
            <div class="glass p-4 sm:p-6 rounded-lg">
                <h2 class="text-xl font-semibold mb-6 flex items-center gap-2">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'download','class' => 'w-5 h-5 text-primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'download','class' => 'w-5 h-5 text-primary']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               name="download_limit" 
                               value="<?php echo e(old('download_limit')); ?>"
                               min="1"
                        ...
                        <?php $__errorArgs = ['download_limit'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="glass p-4 sm:p-6 rounded-lg">
                <h2 class="text-xl font-semibold mb-6 flex items-center gap-2">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'check','class' => 'w-5 h-5 text-primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'check','class' => 'w-5 h-5 text-primary']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
            ...
            <div class="glass p-4 sm:p-6 rounded-lg">
                <h2 class="text-xl font-semibold mb-6 flex items-center gap-2">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'tag','class' => 'w-5 h-5 text-primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'tag','class' => 'w-5 h-5 text-primary']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
        ...
        <div x-show="activeTab === 'details'" x-cloak class="space-y-6">
            ...
            <div class="glass p-4 sm:p-6 rounded-lg">
                <h2 class="text-xl font-semibold mb-6 flex items-center gap-2">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'settings','class' => 'w-5 h-5 text-primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'settings','class' => 'w-5 h-5 text-primary']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <select name="license_type" 
                                ...
                                <option value="GPL" <?php echo e(old('license_type') == 'GPL' ? 'selected' : ''); ?>>GPL (General Public License)</option>
                                <option value="Commercial" <?php echo e(old('license_type') == 'Commercial' ? 'selected' : ''); ?>>Commercial</option>
                                <option value="Personal" <?php echo e(old('license_type') == 'Personal' ? 'selected' : ''); ?>>Personal</option>
                                <option value="Extended" <?php echo e(old('license_type') == 'Extended' ? 'selected' : ''); ?>>Extended</option>
                                <option value="Regular" <?php echo e(old('license_type') == 'Regular' ? 'selected' : ''); ?>>Regular</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="system_requirements" 
                                  ...
                                  class="w-full glass border border-white/10 rounded-lg px-4 py-3 sm:py-2 bg-white/5 focus:outline-none focus:border-primary text-base touch-target"><?php echo e(old('system_requirements')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="support_info" 
                                  ...
                                  class="w-full glass border border-white/10 rounded-lg px-4 py-3 sm:py-2 bg-white/5 focus:outline-none focus:border-primary text-base touch-target"><?php echo e(old('support_info')); ?></textarea>
                        <?php $__errorArgs = ['support_info'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   name="delivery_days" 
                                   value="<?php echo e(old('delivery_days', 0)); ?>" 
                                   min="0" 
                                   inputmode="numeric"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="glass p-4 sm:p-6 rounded-lg">
                <h2 class="text-xl font-semibold mb-6 flex items-center gap-2">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'search','class' => 'w-5 h-5 text-primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'search','class' => 'w-5 h-5 text-primary']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" 
                                  ...
                                  class="w-full glass border border-white/10 rounded-lg px-4 py-3 sm:py-2 bg-white/5 focus:outline-none focus:border-primary text-base touch-target"><?php echo e(old('meta_description')); ?></textarea>
...
function productForm() {
    return {
        ...
        fileSelected: false,
        fileSize: '',
        features: <?php echo json_encode(old('features', ['']), 512) ?>,
        tags: <?php echo json_encode(old('tags', []), 512) ?>,
        tagInput: '',
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\febry\Documents\my_jasa\resources\views/products/create.blade.php ENDPATH**/ ?>