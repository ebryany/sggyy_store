...
<?php endif; ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <div class="lg:col-span-2 space-y-4 sm:space-y-6">
            ...
            <?php if($order->escrow): ?>
                <?php echo $__env->make('components.escrow-status-card-seller', ['order' => $order, 'escrow' => $order->escrow], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?>
...
<?php endif; ?>
            ...
            <?php if($order->type === 'product' && $order->status === 'processing'): ?>
...
<?php endif; ?>
                ...
                <?php if($order->product && $order->product->file_path): ?>
...
<?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('seller.orders.sendProduct', $order)); ?>" 
                      x-data="{ sending: false }"
                      @submit.prevent="
                          sending = true;
                          const formData = new FormData($el);
                          fetch('<?php echo e(route('seller.orders.sendProduct', $order)); ?>', {
                              method: 'POST',
                              headers: {
                    ...
                    <button type="submit" 
                        ...
                        <span x-show="!sending" class="flex items-center justify-center gap-2">
                            <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'send','class' => 'w-4 h-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'send','class' => 'w-4 h-4']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                    ...
                    <a href="<?php echo e(route('seller.products.edit', $order->product)); ?>" 
