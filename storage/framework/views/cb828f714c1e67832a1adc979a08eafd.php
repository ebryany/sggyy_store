<?php $__env->startSection('title', 'Login - Ebrystoree'); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <p class="text-center text-sm sm:text-base text-white/60">
                Belum punya akun? 
                <a href="<?php echo e(route('register')); ?>" class="text-primary hover:text-primary-dark font-semibold transition-colors touch-target">
                    Daftar sekarang
                </a>
            </p>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\febry\Documents\my_jasa\resources\views/auth/login.blade.php ENDPATH**/ ?>