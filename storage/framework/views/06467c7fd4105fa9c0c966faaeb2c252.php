...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'check','class' => 'w-2.5 h-2.5 text-white']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'check','class' => 'w-2.5 h-2.5 text-white']); ?>
...
<?php endif; ?>
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-white/60 text-xs mb-1.5 truncate"><?php echo e(auth()->user()->email); ?></p>
                    <?php if(auth()->user()->email_verified_at): ?>
...
<?php endif; ?>
            ...
            <div class="pt-3 border-t border-white/10">
                <div class="flex items-center justify-between mb-2">
                    ...
                    <span class="text-base font-bold text-white"><?php echo e($profileCompletion['percentage']); ?>%</span>
                </div>
                <div class="w-full h-1.5 bg-white/10 rounded-full overflow-hidden mb-2">
                    <div class="h-full bg-primary transition-all duration-500 rounded-full" style="width: <?php echo e($profileCompletion['percentage']); ?>%"></div>
                </div>
                ...
                <a href="<?php echo e(route('profile.edit')); ?>" 
                   class="inline-flex items-center gap-1.5 px-3 py-1.5 bg-primary/10 hover:bg-primary/20 text-primary rounded-lg font-medium transition-all text-xs border border-primary/30">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'paint','class' => 'w-3.5 h-3.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'paint','class' => 'w-3.5 h-3.5']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-white/60 text-sm mb-2 truncate"><?php echo e(auth()->user()->email); ?></p>
                    <?php if(auth()->user()->email_verified_at): ?>
...
<?php endif; ?>
            ...
            <div class="w-full sm:w-auto">
                <div class="flex items-center justify-between sm:flex-col sm:items-end gap-3 mb-3">
                    ...
                    <span class="text-xl font-bold text-white"><?php echo e($profileCompletion['percentage']); ?>%</span>
                </div>
        ...
        <a href="<?php echo e(route('profile.edit')); ?>" 
           class="glass p-5 rounded-xl border border-white/5 hover:border-primary/30 transition-all text-center group">
            <div class="w-12 h-12 mx-auto mb-3 rounded-lg bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'paint','class' => 'w-6 h-6 text-primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'paint','class' => 'w-6 h-6 text-primary']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
        ...
        <a href="<?php echo e(route('notifications.index')); ?>" 
           class="glass p-5 rounded-xl border border-white/5 hover:border-primary/30 transition-all text-center group relative">
            ...
            <span class="absolute top-2 right-2 bg-primary text-white text-xs rounded-full min-w-[20px] h-5 flex items-center justify-center font-bold"><?php echo e($unreadCount > 99 ? '99+' : $unreadCount); ?></span>
            <?php endif; ?>
            <div class="w-12 h-12 mx-auto mb-3 rounded-lg bg-primary/10 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
        ...
        <div class="glass p-4 sm:p-6 rounded-xl border border-white/5 hover:border-primary/30 transition-all">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-primary/10 flex items-center justify-center">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'document','class' => 'w-5 h-5 sm:w-6 sm:h-6 text-primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'document','class' => 'w-5 h-5 sm:w-6 sm:h-6 text-primary']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
        ...
        <div class="glass p-4 sm:p-6 rounded-xl border border-white/5 hover:border-primary/30 transition-all">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-green-500/10 flex items-center justify-center">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'currency','class' => 'w-5 h-5 sm:w-6 sm:h-6 text-green-400']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'currency','class' => 'w-5 h-5 sm:w-6 sm:h-6 text-green-400']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
            ...
            <p class="text-xl sm:text-2xl font-bold text-green-400 mb-0.5 sm:mb-1 break-words">
                Rp <?php echo e(number_format($walletBalance / 1000, 0)); ?>k
            </p>
            <?php if($lastTopUp): ?>
            <p class="text-[10px] sm:text-xs text-white/50">Top-up: <?php echo e($lastTopUp->created_at->diffForHumans()); ?></p>
            <?php else: ?>
        ...
        <div class="glass p-4 sm:p-6 rounded-xl border border-white/5 hover:border-primary/30 transition-all">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-primary/10 flex items-center justify-center">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'package','class' => 'w-5 h-5 sm:w-6 sm:h-6 text-primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'package','class' => 'w-5 h-5 sm:w-6 sm:h-6 text-primary']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
        ...
        <div class="glass p-4 sm:p-6 rounded-xl border border-white/5 hover:border-primary/30 transition-all">
            <div class="flex items-center justify-between mb-3 sm:mb-4">
                <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-lg bg-primary/10 flex items-center justify-center">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'target','class' => 'w-5 h-5 sm:w-6 sm:h-6 text-primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'target','class' => 'w-5 h-5 sm:w-6 sm:h-6 text-primary']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white"><?php echo e($orderStatusCounts['pending']); ?></p>
                        </div>
                    </div>
                    <a href="<?php echo e(route('orders.index')); ?>?status=pending" class="block w-full px-4 py-2 bg-yellow-500/20 hover:bg-yellow-500/30 text-yellow-400 rounded-lg transition-colors text-center font-medium text-sm">
                        Lihat Semua →
                    </a>
                </div>
...
<?php endif; ?>
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white"><?php echo e($orderStatusCounts['processing']); ?></p>
                        </div>
                    </div>
                    <a href="<?php echo e(route('orders.index')); ?>?status=processing" class="block w-full px-4 py-2 bg-blue-500/20 hover:bg-blue-500/30 text-blue-400 rounded-lg transition-colors text-center font-medium text-sm">
                        Lihat Semua →
                    </a>
                </div>
...
<?php endif; ?>
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white"><?php echo e($orderStatusCounts['completed']); ?></p>
                        </div>
                    </div>
                    <a href="<?php echo e(route('orders.index')); ?>?status=completed" class="block w-full px-4 py-2 bg-green-500/20 hover:bg-green-500/30 text-green-400 rounded-lg transition-colors text-center font-medium text-sm">
                        Lihat Semua →
                    </a>
                </div>
...
<?php endif; ?>
                        ...
                        <div>
                            ...
                            <p class="text-3xl font-bold text-white"><?php echo e($orderStatusCounts['cancelled']); ?></p>
                        </div>
                    </div>
                    <a href="<?php echo e(route('orders.index')); ?>?status=cancelled" class="block w-full px-4 py-2 bg-red-500/20 hover:bg-red-500/30 text-red-400 rounded-lg transition-colors text-center font-medium text-sm">
                        Lihat Semua →
                    </a>
                </div>
            </div>
...
<?php endif; ?>
                    ...
                    <span class="px-2 py-1 bg-yellow-500/20 text-yellow-400 rounded text-xs font-medium"><?php echo e($orderStatusCounts['pending']); ?></span>
                </div>
                <p class="text-white/60 text-xs mb-1">Pending</p>
                <p class="text-xl font-bold text-white"><?php echo e($orderStatusCounts['pending']); ?></p>
            </div>
...
<?php endif; ?>
                    ...
                    <span class="px-2 py-1 bg-blue-500/20 text-blue-400 rounded text-xs font-medium"><?php echo e($orderStatusCounts['processing']); ?></span>
                </div>
                <p class="text-white/60 text-xs mb-1">Processing</p>
                <p class="text-xl font-bold text-white"><?php echo e($orderStatusCounts['processing']); ?></p>
            </div>
...
<?php endif; ?>
                    ...
                    <span class="px-2 py-1 bg-green-500/20 text-green-400 rounded text-xs font-medium"><?php echo e($orderStatusCounts['completed']); ?></span>
                </div>
                <p class="text-white/60 text-xs mb-1">Completed</p>
                <p class="text-xl font-bold text-white"><?php echo e($orderStatusCounts['completed']); ?></p>
            </div>
...
<?php endif; ?>
                    ...
                    <span class="px-2 py-1 bg-red-500/20 text-red-400 rounded text-xs font-medium"><?php echo e($orderStatusCounts['cancelled']); ?></span>
                </div>
                <p class="text-white/60 text-xs mb-1">Cancelled</p>
                <p class="text-xl font-bold text-white"><?php echo e($orderStatusCounts['cancelled']); ?></p>
            </div>
        </div>
    </div>
...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <p class="text-xs text-white/50"><?php echo e($inProgressOrders->count()); ?> tugas aktif</p>
                    </div>
                </div>
...
<?php endif; ?>
                        ...
                        <p class="text-xs text-white/50 mt-1"><?php echo e($order->order_number); ?></p>
                    </div>
                ...
                <div class="mb-4">
                    <div class="flex justify-between text-xs text-white/60 mb-2">
                        <span>Progress</span>
                        <span class="font-semibold text-white"><?php echo e($order->progress ?? 0); ?>%</span>
                    </div>
                    <div class="h-2 bg-white/10 rounded-full overflow-hidden">
                        <div class="h-full bg-primary transition-all duration-500 rounded-full" style="width: <?php echo e($order->progress ?? 0); ?>%"></div>
                    </div>
                </div>
                ...
                <div class="flex justify-between items-center pt-4 border-t border-white/10">
                    ...
                    <div class="flex items-center gap-2">
                        <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'clock','class' => 'w-4 h-4 text-white/50']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'clock','class' => 'w-4 h-4 text-white/50']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php unset($__componentOriginalce262628e3a8d44dc38fd1f3965181bc); ?>
<?php endif; ?>
                        <span class="text-xs font-medium <?php echo e($order->deadline_at->isPast() ? 'text-red-400' : ($order->deadline_at->diffInHours() < 24 ? 'text-yellow-400' : 'text-white/60')); ?>">
                    ...
                    <?php endif; ?>
                    <span class="text-base font-bold text-white">Rp <?php echo e(number_format($order->total / 1000, 0)); ?>k</span>
                </div>
            </a>
...
<?php endif; ?>
                ...
                <div>
                    ...
                    <p class="text-xs text-white/50"><?php echo e($completedOrders->count()); ?> file tersedia</p>
                </div>
            </div>
...
<?php endif; ?>
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-white/50"><?php echo e($order->completed_at?->format('d M Y')); ?></p>
                    </div>
                </div>
                    ...
                    <div class="flex items-start sm:items-center justify-between gap-3">
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2 mb-1">
                                <p class="font-semibold text-sm truncate text-white group-hover:text-primary transition-colors"><?php echo e($order->order_number); ?></p>
                            ...
                            <p class="text-xs text-white/50 truncate flex items-center gap-1.5">
                                <?php if($order->type === 'product'): ?>
                                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'package','class' => 'w-3.5 h-3.5 text-white/50']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'package','class' => 'w-3.5 h-3.5 text-white/50']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                                ...
                                <?php else: ?>
                                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'target','class' => 'w-3.5 h-3.5 text-white/50']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'target','class' => 'w-3.5 h-3.5 text-white/50']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
...
<?php endif; ?>
                        ...
                        <div class="text-right flex-shrink-0">
                            <p class="font-bold text-white text-sm">Rp <?php echo e(number_format($order->total / 1000, 0)); ?>k</p>
                            <p class="text-xs text-white/50"><?php echo e($order->created_at->diffForHumans()); ?></p>
                        </div>
                    </div>
                </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
                        <?php if($unreadCount > 0): ?>
                        <span class="absolute -top-1 -right-1 bg-primary text-white text-[10px] rounded-full min-w-[18px] h-[18px] flex items-center justify-center font-bold"><?php echo e($unreadCount > 99 ? '99+' : $unreadCount); ?></span>
                        <?php endif; ?>
                    </div>
                    <div>
                        <h2 class="text-lg font-semibold">Notifikasi Terbaru</h2>
                        <p class="text-xs text-white/50"><?php echo e($unreadCount > 0 ? $unreadCount . ' belum dibaca' : 'Tidak ada notifikasi baru'); ?></p>
                    </div>
                </div>
                <a href="<?php echo e(route('notifications.index')); ?>" 
                   class="px-4 py-2 glass hover:bg-white/10 rounded-lg font-medium transition-all text-sm border border-white/10">
            ...
            <div class="space-y-3">
                ...
                <a href="<?php echo e(route('notifications.index')); ?>" 
                   class="block glass glass-hover p-4 rounded-lg transition-all border <?php echo e(!$notification->is_read ? 'border-primary/30 bg-primary/5' : 'border-white/5'); ?> group">
                    <p class="font-medium text-sm <?php echo e(!$notification->is_read ? 'text-primary' : 'text-white/90'); ?> mb-1">
                        <?php echo e($notification->message); ?>

                    </p>
                    <p class="text-xs text-white/50"><?php echo e($notification->created_at->diffForHumans()); ?></p>
                </a>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            <?php else: ?>
        ...
        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                <div class="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center">
                    <?php if (isset($component)) { $__componentOriginalce262628e3a8d44dc38fd1f3965181bc = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.icon','data' => ['name' => 'dashboard','class' => 'w-6 h-6 text-primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('icon'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'dashboard','class' => 'w-6 h-6 text-primary']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalce262628e3a8d44dc38fd1f3965181bc)): ?>
<?php $attributes = $__attributesOriginalce262628e3a8d44dc38fd1f3965181bc; ?>
