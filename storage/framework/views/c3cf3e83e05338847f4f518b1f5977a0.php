            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-white/5 hover:bg-white/5">
                        ...
                        <td class="py-3 px-4 font-semibold text-sm">Rp <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></td>
                        <td class="py-3 px-4">
                            <?php if($order->payment): ?>
                                <span class="text-xs text-white/60"><?php echo e(ucfirst(str_replace('_', ' ', $order->payment->payment_method))); ?></span>
                            <?php else: ?>
        ...
        <div class="md:hidden space-y-3">
            ...
            <a href="<?php echo e(route('seller.orders.show', $order)); ?>" class="block glass glass-hover p-4 rounded-lg touch-target">
                ...
                <div class="flex items-center justify-between mt-2">
                    <div>
                        <span class="font-bold text-primary text-base">Rp <?php echo e(number_format($order->total_amount, 0, ',', '.')); ?></span>
                        <?php if($order->payment): ?>
                            <p class="text-xs text-white/60 mt-1"><?php echo e(ucfirst(str_replace('_', ' ', $order->payment->payment_method))); ?></p>
                        <?php endif; ?>
                    </div>
