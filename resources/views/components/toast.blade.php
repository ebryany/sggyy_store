        ...
        <div class="flex items-start space-x-2 sm:space-x-3">
            ...
            <div class="flex-shrink-0"
                ...
                <span x-show="type === 'error'">
                    <x-icon name="x" class="w-5 h-5 sm:w-6 sm:h-6" />
                </span>
                <span x-show="type === 'success'">
                    <x-icon name="check" class="w-5 h-5 sm:w-6 sm:h-6" />
                </span>
                <span x-show="type === 'warning'">
                    <x-icon name="warning" class="w-5 h-5 sm:w-6 sm:h-6" />
                </span>
                <span x-show="type === 'info'">
                    <x-icon name="info" class="w-5 h-5 sm:w-6 sm:h-6" />
                </span>
            </div>
